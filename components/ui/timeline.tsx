    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          From very basic include intro and how it work in background to powerfull
          hacking scripts and hacking tools.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#161616] dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-[#1f0104] dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
